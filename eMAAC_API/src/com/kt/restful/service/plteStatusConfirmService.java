...
@Path("/app/pltestatusconfirm")
public class plteStatusConfirmService implements Listener {
	...
	private static Logger logger = LogManager.getLogger(plteStatusConfirmService.class);
	...
	public Response MdnAuthRequest(@Context HttpServletRequest req, 
		...
		if(PLTEConnector.getInstance().isLogFlag()) {
			logger.info("=============================================");
			logger.info(ApiDefine.PLTE_STATUS_CONFIRM.getName());
			logger.info("MDN : " + mdn);
		...
		PLTEManager.getInstance().sendCommand(ApiDefine.PLTE_STATUS_CONFIRM.getName(), params, this, clientID, "NOT USED");
...
//		
//		dataObject.put("compCode", 1234);
//		dataObject.put("compName", "Ariel");
//		dataObject.put("plteStatusCode", "21000");
//		dataObject.put("plteStatus", "ON");
//		
//		responseJSONObject.put("data", dataObject);
//		this.msg = responseJSONObject.toString();
//		// [/TEMP]
						
		if(PLTEConnector.getInstance().isLogFlag()) {
			logger.info("=============================================");
			logger.info(ApiDefine.PLTE_STATUS_CONFIRM.getName() + " REPONSE");
